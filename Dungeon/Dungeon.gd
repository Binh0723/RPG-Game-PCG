...
enum Tiles { GROUND1 = 0,GROUND2 = 1,GROUND3 = 2,MAGMA = 3,ICE = 4,POISON = 5,EARTH = 6, ROOF = 7 ,BRIDGE = 8}

var tree = {}
var leaves = []
var leaf_id = 0
var rooms = []
var ground = [Tiles.GROUND1,Tiles.GROUND2,Tiles.GROUND3]
func _ready():
	generate()
func generate():
	clear()
...
func connect_leaves(leaf1, leaf2):
	...
	for i in range(x, x+w):
		for j in range(y, y+h):
			if(get_cell(i, j) == Tiles.ROOF): set_cell(i, j, Tiles.BRIDGE)
...
func clear_deadends():
	...
	while !done:
		...
		for cell in get_used_cells():
			if get_cellv(cell) != Tiles.BRIDGE: continue
